...
function hpa_scripts() {
	...
	wp_enqueue_style( 'slick', 'https://unpkg.com/swiper/css/swiper.min.css', [], _S_VERSION );
	...
	wp_enqueue_script( 'slick', 'https://unpkg.com/swiper/js/swiper.min.js', ['jquery'], _S_VERSION, true );
